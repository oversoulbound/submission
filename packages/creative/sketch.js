...
let sketch = (p5) => {
  ...
  let nfts = [{ phrase: "polygon id sbt" }];
  p5.preload = () => {
  ...
  p5.draw = () => {
    ...
    p5.image(image, 310, 330, 100, 100);
    ...
    subjects.push(new Subject(720 / 2 - p5.random(-15, 15), 650, 20, 20, phrases[count % phrases.length], p5, engine));
    count++;
  };
